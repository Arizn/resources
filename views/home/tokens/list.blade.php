...
<div class="row tile_count">
	...
	<div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count"> 
		...
		<span class="count_bottom">
			...
			<a target="_blank" class="blue" href="{{str_replace('[SYM]',$token->symbol,setting('affiliatelink'))}}">BUY</a>&nbsp;|&nbsp; 
			<a target="_blank" class="red" href="{{str_replace('[SYM]',$token->symbol,setting('affiliatelink'))}}">SELL</a>
		</span> 
	</div>
	@endforeach
