    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><a href="{{ url('/admin/rates') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i>Go Back</button></a> &nbsp;&nbsp; Create  a new Exchange Rate</h3>
            </div>
			...
			<div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/rates') }}" accept-charset="UTF-8" class="form-horizontal ajax_form" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('_admin.rates.form')
