    ...
    <div class="row">
        <div class="col-xs-12">
          ...
          <div class="panel-heading">
            ...
            <a href="{{URL::to('/admin/users/'.$user->id)}}" class="btn btn-primary btn-xs pull-right" style="margin-left: 1em;">
              <i class="fa fa-fw fa-mail-reply" aria-hidden="true"></i>
             Back  <span class="hidden-xs">to User</span>
            </a>

            <a href="{{URL::to('/admin/users/')}}" class="btn btn-info btn-xs pull-right">
              <i class="fa fa-fw fa-mail-reply" aria-hidden="true"></i>
